...
import {validateInputV} from './video.js';
import {validateInputRes} from './restoran.js';
    ...
    btnSave.addEventListener("click", (e) => {
        if (categoryName === "Ресторан") {
            let objInfo = {
                ...
                keywords: [],
                Weiht: "",
                stopList: "", ageRestrictions: "",
                like: "",
                ageRestrictions: ""
            };
            validateInputRes(objInfo);
...
const restoration = ["Назва продукта", "Введіть грамовку", "Введіть склад", "Вартість страви", "Зображення", "Гарячі слова, розділяйте комою.", "Вага фінальна"];
const store = ["Назва продукта", "Введіть вартість", "Посилання на зображення", "Опис товару", "Гарячі слова, розділяйте комою."]
const video = ['Назва', 'Дата публікації', 'Посилання на відео'];
