...
const showInformation = function(x){
    document.write(`<div class='box'>    
    <div id='number'>Number: ${x.id}</div>      
    <div id='name'>Name: ${x.name}</div>        
    <div id='mail'>Email: ${x.email}</div>      
    <div id='coment'><p id = 'p'>Feedback:</p>"${x.body}"</div>   
    </div>`);                                    
        }
   
    
arr.forEach(showInformation);
